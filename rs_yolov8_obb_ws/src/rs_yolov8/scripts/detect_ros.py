...
class YoloV8:
    def __init__(self, yolov8_yaml_path='/home/lenovo/Downloads/2Ddetection/rs_yolov8_obb_ws/src/rs_yolov8/scripts/config/yolov8obb_demo.yaml'):
        #载入配置文件
    ...
    def detect(self, img, canvas=None):
        ...
        # NMS 非极大值抑制
        pred = non_max_suppression_obb(pred, self.yolov8['threshold']['confidence'], self.yolov8['threshold']['iou'], self.classes, self.agnostic_nms, multi_label=True, max_det=self.max_det)                                
        t_end = time_sync()
...
class YoloV8Detection:
    ...
    def init_ros(self):
        config_path = rospy.get_param("/config_path", "/home/lenovo/Downloads/2Ddetection/rs_yolov8_obb_ws/src/rs_yolov8/scripts/config/yolov8obb_demo.yaml")
        return config_path
