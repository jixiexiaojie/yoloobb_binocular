...
(cl:defmethod cl:initialize-instance :after ((m <Info>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Info)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rs_yolov8-msg:<Info> is deprecated: use rs_yolov8-msg:Info instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs_yolov8-msg:x-val is deprecated.  Use rs_yolov8-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs_yolov8-msg:y-val is deprecated.  Use rs_yolov8-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs_yolov8-msg:z-val is deprecated.  Use rs_yolov8-msg:z instead.")
  (z m))

(cl:ensure-generic-function 'angle-val :lambda-list '(m))
(cl:defmethod angle-val ((m <Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs_yolov8-msg:angle-val is deprecated.  Use rs_yolov8-msg:angle instead.")
  (angle m))

(cl:ensure-generic-function 'classification-val :lambda-list '(m))
(cl:defmethod classification-val ((m <Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs_yolov8-msg:classification-val is deprecated.  Use rs_yolov8-msg:classification instead.")
  (classification m))

(cl:ensure-generic-function 'confidence-val :lambda-list '(m))
(cl:defmethod confidence-val ((m <Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs_yolov8-msg:confidence-val is deprecated.  Use rs_yolov8-msg:confidence instead.")
  (confidence m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Info>)))
  ...
  "1c0cd277fce00eb84b787e9914662978")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Info)))
  "Returns md5sum for a message object of type 'Info"
  "1c0cd277fce00eb84b787e9914662978")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Info>)))
  ...
  (cl:format cl:nil "float64 x~%float64 y~%float64 z~%float64 angle~%string classification~%float64 confidence~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Info)))
  "Returns full string definition for message of type 'Info"
  (cl:format cl:nil "float64 x~%float64 y~%float64 z~%float64 angle~%string classification~%float64 confidence~%~%"))
